  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">A General-Purpose Swarm Intelligence Engine</span>
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class=”highlight-bold”>MiroFish</span> can extract real-world seeds and auto-generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view and find <span class=”highlight-code”>”locally optimal solutions”</span> through complex swarm interactions in dynamic environments.
            </p>
            <p class=”slogan-text”>
              Let the future rehearse in agent swarms; let decisions win after a thousand battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction need in natural language (e.g., If the university reverses the disciplinary action, what public opinion trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
