...
const renderGraph = () => {
  ...
  // Process edge data, count edges between each pair of nodes and assign indices
  const edgePairCount = {}
  ...
  tempEdges.forEach(e => {
    ...
    if (totalCount > 1) {
      ...
      // If edge direction is reversed from canonical, flip the curvature
  ...
  const simulation = d3.forceSimulation(nodes)
    ...
    // Add gravity toward center to keep isolated node clusters centered
