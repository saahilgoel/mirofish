<template>
  ...
  >
    <!-- Background decoration: tech grid lines (only shown with projects) -->
    ...
    <!-- Card Container (only shown with projects) -->
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 "Start Simulation" and Step5 "Deep Interaction" require live sessions and do not support historical playback</span>
            </div>
          </div>
        </div>
      </Transition>
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Shorter delay (50ms) for expanding, longer delay (200ms) for collapsing for stability
