...
// Format simulated elapsed time (based on round and minutes per round)
...
const doStartSimulation = async () => {
  ...
  // Reset all state first to avoid contamination from previous simulation
  resetAllState()
...
// Track previous round per platform for change detection logging
...
const checkPlatformsCompleted = (data) => {
  ...
  // Determine if platform is enabled via actions_count > 0 or running was true
