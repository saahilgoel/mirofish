          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report agent, with 4 specialized tools and full MiroFish memory access</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based BFS algorithm that reconstructs event propagation paths and captures the full topology of information flow</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewing that conducts parallel multi-turn dialogues with simulated agents, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean <br> before paragraph tag right after block elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix non-contiguous ordered list numbering: keep numbers incrementing when <ol> items are separated by paragraphs
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      ...
      // Fallback: array format compatibility
...
/* Fix ordered list numbering - use CSS counters for sequential numbering across multiple ol elements */
.message-text {
