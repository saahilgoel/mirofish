...
class ZepToolsService:
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from a graph (paginated, with temporal information)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all graph edges, then filters those related to the specified node
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Gets the full picture view, including all relevant content and historical/expired information:
    ...
    def interview_agents(
        ...
        Calls the real OASIS interview API to interview running Agents in a simulation:
        ...
        4. Calls /api/simulation/interview/batch API for real interviews (dual-platform simultaneous interview)
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                clean_text = re.sub(r'Question\d+[:\s]*', '', clean_text, flags=re.IGNORECASE)
                ...
                # Strategy 2 (supplementary): Properly paired quoted text
                if not key_quotes:
...
1. Distill main viewpoints from each party
2. Identify consensus and disagreements
3. Highlight valuable quotes
4. Be objective and neutral, not biased toward any party
