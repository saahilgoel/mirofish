...
class PlatformConfig:
    ...
    # Viral threshold (how many interactions to trigger spread)
...
- Target user group is Chinese, must conform to Beijing time daily schedule
...
- 19-22 evening is peak time (activity coefficient 1.5)
- After 23:00 activity declines (activity coefficient 0.5)
- General pattern: low activity early morning, gradually increasing in morning, moderate during work hours, evening peak
- **Important**: The following example values are for reference only; you need to adjust specific time periods based on the nature of the event and characteristics of participant groups
  - Example: Student group peak may be 21-23; media active all day; official institutions only during work hours
  - Example: Breaking hot topics may lead to late-night discussion, off_peak_hours can be shortened accordingly
...
For example: official statements should be published by Official/University type, news by MediaOutlet, student views by Student.
...
{{
    ...
    def _assign_initial_post_agents(
        ...
        """
        Assign suitable poster Agent to initial posts
...
- **Schedule conforms to Chinese daily habits**: Almost no activity 0-5 AM, most active 19-22 PM
...
{{
    ...
    def _generate_agent_config_by_rule(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        if entity_type in ["university", "governmentagency", "ngo"]:
            ...
            # Expert/Professor: active during work + evening hours, moderate frequency
            return {
                "activity_level": 0.4,
                "posts_per_hour": 0.3,
            ...
            # Student: primarily evening, high frequency
            return {
                "activity_level": 0.8,
                "posts_per_hour": 0.6,
